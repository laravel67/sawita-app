...
<div class="card">
    ...
    <div class="card-body">
        <form id="analysisForm" action="{{ route('guide.update', $guide->id) }}" method="POST">
            @method('put')
            @csrf
            <div class="mb-4">
                ...
                <select name="pupuk_id" id="pupuk_id" class="form-control @error('pupuk_id') is-invalid @enderror">
                    ...
                    <option value="{{ $pupuk->id }}" {{ $pupuk->id == old('pupuk_id', $guide->pupuk_id) ? 'selected' :
                        '' }}>
                        {{ $pupuk->name }}
                    </option>
                    @endforeach
            ...
            <div class="mb-4">
                ...
                <input id="body" type="hidden" name="body" value="{{ old('body',$guide->body) }}">
